...
class HomeView
{
 	public function Render(){
		$theModel = new Model();
		$CurrentContent = $theModel->pageContent('Home');
?>
	...
	<body>
		<div id="container">
			...
			<div id="secondary">
				...
				<p>Comp</p>
				<a href="../control/control_Class.php?command=competition"><img class="youtube" src="../images/computer.png" alt="computer" align="center"></a>
			</div>
